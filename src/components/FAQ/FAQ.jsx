  ...
  return (
    ...
    <Accordion className="faq-accordion">
      ...
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body>São os Planos: TocaPlay Gold com todas funcionalidades liberadas, TocaPlay Family pra toda sua família curti o melhor das atualidades da música ou TocaPlay PRO para utilização profissional podendo fazer playback.
        </Accordion.Body>
      </Accordion.Item>
